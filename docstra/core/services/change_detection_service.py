...
class ChangeAnalysis:
    ...
    def has_changes(self) -> bool:
        ...
        return len(self.changed_files) > 0 or len(self.new_files) > 0 or len(self.deleted_files) > 0
...
class ChangeDetectionService:
    ...
    def detect_changes_since_last_generation(self, codebase_path: str) -> ChangeAnalysis:
    ...
    def detect_changes_from_git(self, codebase_path: str, base_ref: str = "HEAD~1") -> ChangeAnalysis:
