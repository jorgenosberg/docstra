...
class DocumentationOverrideManager:
    ...
    def set_skip_override(self, file_path: str, description: Optional[str] = None, created_by: Optional[str] = None) -> None:
    ...
    def set_template_override(self, file_path: str, template_content: str, description: Optional[str] = None, created_by: Optional[str] = None) -> None:
    ...
    def set_manual_content_override(self, file_path: str, content: str, description: Optional[str] = None, created_by: Optional[str] = None) -> None:
    ...
    def list_overrides(self, override_type: Optional[str] = None) -> List[DocumentationOverride]:
    ...
    def get_override_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "by_type": by_type,
            "last_created": max(o.created_at for o in self.overrides.values()) if self.overrides else 0
        }
    
    def cleanup_missing_files(self, valid_file_paths: Optional[List[str]] = None) -> int:
