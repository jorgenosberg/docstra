...
class DocumentationDependencyTracker:
    ...
    def track_documentation_dependencies(
        ...
        if repo_map:
            ...
            cross_references = repo_map.get_cross_references(document.metadata.filepath)
    ...
    def get_impacted_documentation(self, changed_files: List[str]) -> List[str]:
        ...
        for doc_path, dep in self.dependencies.items():
            ...
            if any(
                source_file in changed_files_set for source_file in dep.source_files
            ):
    ...
    def _extract_generation_context(
        self, document: Document, repo_map: Optional[RepositoryMap]
    ) -> Dict[str, Any]:
        ...
        if repo_map:
            ...
            if file_node:
                context.update(
                    {
                        "module_category": repo_map._categorize_module(
    ...
    def get_dependency_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_update": max(dep.last_generated for dep in self.dependencies.values())
